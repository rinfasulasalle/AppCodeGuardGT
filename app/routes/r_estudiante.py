...
def create():
    ...
    # Verifica si existe un Admin o Docente con ese dni
    if Administracion.query.filter_by(dni_usuario= dni_usuario).first() or Docente.query.filter_by(dni_usuario= dni_usuario).first():
